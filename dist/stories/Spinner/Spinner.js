...
function Spinner(props) {
    ...
    var loadingProps = width && height
        ? __assign(__assign({}, props), { width: width, height: height }) : __assign(__assign({}, props), { width: size, height: size });
    return loading ? (_jsx(Wrapper, __assign({ className: className }, { children: _jsx(Loading, __assign({}, loadingProps), Math.random()) }))) : (_jsx(_Fragment, {}));
}
